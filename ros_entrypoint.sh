...
if [ -f "$HOME/catkin_extras/devel/setup.bash" ]; then
    source "$HOME/catkin_extras/devel/setup.bash"
    echo "Sourced $HOME/catkin_extras/devel/setup.bash"
else
    echo "No se encontró $HOME/catkin_extras/devel/setup.bash"
fi
